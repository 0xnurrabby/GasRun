...
function laneGeometry() {
  ...
  // Slightly larger road so the playfield fills the screen better (visual + lane geometry stay consistent)
...
function render() {
  ...
  drawRoundedRect(g.roadX + 2, g.roadY + 6, g.roadW, g.roadH, 26);
  ctx.fill();
  ...
  const edgeTop = g.roadY + 14;
  const edgeBot = g.roadY + g.roadH - 14;
