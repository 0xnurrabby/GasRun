...
<html lang="en">
  <head>
    ...
    <style>
      ...
      @font-face{
        font-family: "Akando";
        src: url("${HOME_URL}assets/fonts/Akando-Regular.otf") format("opentype");
        font-weight: 400;
        font-style: normal;
        font-display: swap;
      }
      body{font-family:"Akando", system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;}
    </style>
  </head>
